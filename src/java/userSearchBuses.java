...
public class userSearchBuses extends HttpServlet {
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // Book form
                out.println("<td>");
                out.println("<form action='BookBus' method='post' style='margin:0;'>");
        ...
        out.println("<a href='userbuses.html' class='back-btn'>Back to Search</a>");
