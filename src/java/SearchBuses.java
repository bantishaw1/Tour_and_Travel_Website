...
public class SearchBuses extends HttpServlet {
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        out.println("<html><head><meta charset='UTF-8'><title>Available Buses</title>");
        ...
        out.println("<h1>Available Buses</h1>");
        ...
        try {
            ...
            String sql = "SELECT bus_id, bus_name, source, destination, travel_date, price, seats_available " +
                         "FROM buses " +
            ...
            while (rs.next()) {
                ...
                String fname = rs.getString("bus_name");
                ...
                // Book form
                out.println("<td>");
                out.println("<form action='busloginRequired.html' method='post' style='margin:0;'>");
                out.println("<input type='hidden' name='busId' value='" + busId + "'/>");
            ...
            if (!found) {
                out.println("<p style='color:red;font-weight:bold;'>No buses found!</p>");
            }
        ...
        out.println("<a href='buses.html' class='back-btn'>Back to Search</a>");
