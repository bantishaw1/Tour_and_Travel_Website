...
public class userSearchTrains extends HttpServlet {
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // Book form
                out.println("<td>");
                out.println("<form action='BookTrain' method='post' style='margin:0;'>");
        ...
        out.println("<a href='usertrains.html' class='back-btn'>Back to Search</a>");
