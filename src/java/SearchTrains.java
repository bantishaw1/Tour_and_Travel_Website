...
public class SearchTrains extends HttpServlet {
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        out.println("<html><head><meta charset='UTF-8'><title>Available Trains</title>");
        ...
        try {
            ...
            String sql = "SELECT train_id, train_name, source, destination, travel_date, price, seats_available " +
                         "FROM trains " +
            ...
            while (rs.next()) {
                ...
                String fname = rs.getString("train_name");
                ...
                // Book form
                out.println("<td>");
                out.println("<form action='TrainloginRequired.html' method='post' style='margin:0;'>");
                out.println("<input type='hidden' name='flightId' value='" + trainId + "'/>");
            ...
            if (!found) {
                out.println("<p style='color:red;font-weight:bold;'>No trains found!</p>");
            }
        ...
        out.println("<a href='trains.html' class='back-btn'>Back to Search</a>");
