...
public class ConfirmBooking extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Debugging
        System.out.println("DEBUG: flightId=" + flightId + ", payment=" + paymentMethod + ", txn=" + userTxnId);

        // Fake Unique Transaction ID
        String sysTxnId = "TXN-" + (int)(Math.random() * 100000);

        int flightIdInt = safeInt(flightId);
        ...
        try {
            ...
            String sql = "INSERT INTO bookings " +
                         "(BOOKING_ID, FLIGHT_ID, PASSENGER_NAME, PASSENGER_EMAIL, PASSENGER_PHONE, " +
        ...
        out.println("<p><b>Flight ID:</b> " + flightIdInt + "</p>");
