...
@WebServlet("/BusConfirmBooking")
public class BusConfirmBooking extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Debugging
        System.out.println("DEBUG: busId=" + busId + ", payment=" + paymentMethod + ", txn=" + userTxnId);

        // Fake Unique Transaction ID
        String sysTxnId = "TXN-" + (int)(Math.random() * 100000);

        int busIdInt = safeInt(busId);
        ...
        try {
            ...
            String sql = "INSERT INTO bus_bookings " +
                         "(BOOKING_ID, BUS_ID, PASSENGER_NAME, PASSENGER_EMAIL, PASSENGER_PHONE, " +
        ...
        out.println("<p><b>Bus ID:</b> " + busIdInt + "</p>");
