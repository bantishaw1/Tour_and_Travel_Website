...
public class updateflights extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            StringBuilder sql = new StringBuilder("UPDATE flights SET ");
            boolean comma = false;

            if(flightName != null && !flightName.isEmpty()) {
                sql.append("flight_name=?");
                comma = true;
            }
            ...
            int idx = 1;
            if(flightName != null && !flightName.isEmpty()) ps.setString(idx++, flightName);
            ...
            ps.setString(idx, flightId); // WHERE condition

            int i = ps.executeUpdate();
            if(i > 0) {
                out.println("<h3 style='color:green'>Flight Updated Successfully!</h3>");
            } else {
                out.println("<h3 style='color:red'>No Flight Found with ID: " + flightId + "</h3>");
            }
