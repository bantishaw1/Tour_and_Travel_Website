...
public class BookTrain extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("SELECT * FROM trains WHERE train_id=?");
            ...
            if (rs.next()) {
                ...
                out.println("<form action='TrainPayment' method='post' class='box'>");
                out.println("<input type='hidden' name='trainId' value='" + rs.getInt("train_id") + "'/>");
                ...
                out.println("<h3 style='color:red;'>Train not found!</h3>");
            }
