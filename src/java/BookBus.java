    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (rs.next()) {
                ...
                out.println("<form action='BusPayment' method='post' class='box'>");
                out.println("<input type='hidden' name='busId' value='" + rs.getInt("bus_id") + "'/>");
                ...
                out.println("<h3 style='color:red;'>Bus not found!</h3>");
            }
